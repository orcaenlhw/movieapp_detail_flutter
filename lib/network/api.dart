...
import 'package:movieapp_detail_flutter/models/cast.dart';
import 'package:http/http.dart' as http;
import 'package:movieapp_detail_flutter/models/res_popular.dart';
import 'package:movieapp_detail_flutter/models/resp_cast.dart';
...
class API {
  ...
  Future<List<Cast>> getCast(int movieID) async {
    ...
    if (response.statusCode == 200) {
      ...
      // It the server did not return a 200 OK response, then throw an exception.
      throw Exception('Failed to load album');
    }
  }
}
